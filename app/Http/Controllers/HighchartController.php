...
class HighchartController extends Controller
{
    ...
    public function pieChart()
    {
        ...
        $data = DB::table('m_dasawisma')
            ...
            ->selectRaw('m_kota.nama_kota, COUNT(m_dasawisma.dasawisma_id) as total')
            ->where('m_dasawisma.record_status', '=', '0')
            ->groupBy('m_kota.nama_kota')
    ...
    public function barChart()
    {
        $data = DB::table('m_dasawisma')
            ...
            ->leftJoin('m_kecamatan', 'm_kelurahan.kecamatan_id', '=', 'm_kecamatan.kecamatan_id')
            ->leftJoin('m_kota', 'm_kecamatan.kota_id', '=', 'm_kota.kota_id')
            ->selectRaw('m_kecamatan.nama_kecamatan, COUNT(m_dasawisma.dasawisma_id) as total')
            ->where('m_dasawisma.record_status', '=', '0')
            ->where('m_kota.kota_id', '=', 'K00005') // Filter untuk Jakarta Timur
            ->groupBy('m_kecamatan.nama_kecamatan')
